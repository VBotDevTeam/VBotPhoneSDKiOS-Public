...
#define VBotTransportTypeString(VBotTransportType) [@[@"VBotTransportTypeUDP", @"VBotTransportTpeUDP6", @"VBotTransportTypeTCP", @"VBotTransportTypeTCP6", @"VBotTransportTypeTLS", @"VBotTransportTypeTLS6"] objectAtIndex:VBotTransportType]
