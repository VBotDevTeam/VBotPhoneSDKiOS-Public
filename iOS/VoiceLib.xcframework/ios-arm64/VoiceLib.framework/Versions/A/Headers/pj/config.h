 ...
 */
#if defined(_MSC_VER)
#  include <VoiceLib/pj/compat/cc_msvc.h>
#elif defined(__clang__)
#  include <VoiceLib/pj/compat/cc_clang.h>
#elif defined(__GNUC__)
#  include <VoiceLib/pj/compat/cc_gcc.h>
#elif defined(__CW32__)
#  include <VoiceLib/pj/compat/cc_mwcc.h>
#elif defined(__MWERKS__)
#  include <VoiceLib/pj/compat/cc_codew.h>
#elif defined(__GCCE__)
#  include <VoiceLib/pj/compat/cc_gcce.h>
#elif defined(__ARMCC__)
#  include <VoiceLib/pj/compat/cc_armcc.h>
#else
 ...
 */
     ...
     * Autoconf
     */
#   include <VoiceLib/pj/compat/os_auto.h>

#elif defined(PJ_SYMBIAN) && PJ_SYMBIAN!=0
    /*
     * SymbianOS
     */
#  include <VoiceLib/pj/compat/os_symbian.h>
...
#   include <VoiceLib/pj/compat/os_win32_wince.h>
...
#   include <VoiceLib/pj/compat/os_winphone8.h>
...
#   include <VoiceLib/pj/compat/os_winuwp.h>
...
#   undef PJ_WIN32
#   define PJ_WIN32 1
#   include <VoiceLib/pj/compat/os_win32.h>
...
#   undef PJ_LINUX
#   define PJ_LINUX         1
#   include <VoiceLib/pj/compat/os_linux.h>

#elif defined(PJ_PALMOS) && PJ_PALMOS!=0
    /*
     * Palm
     */
#  include <VoiceLib/pj/compat/os_palmos.h>
...
#   undef PJ_SUNOS
#   define PJ_SUNOS         1
#   include <VoiceLib/pj/compat/os_sunos.h>
...
#   include <VoiceLib/pj/compat/os_darwinos.h>

#elif defined(PJ_RTEMS) && PJ_RTEMS!=0
    /*
     * RTEMS
     */
#  include <VoiceLib/pj/compat/os_rtems.h>
#else
 ...
 */
     ...
     * Autoconf configured
     */
#include <VoiceLib/pj/compat/m_auto.h>
