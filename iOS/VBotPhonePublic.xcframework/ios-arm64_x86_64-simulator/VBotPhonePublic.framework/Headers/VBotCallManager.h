 ...
 */
- (void)startCallToNumber:(NSString * _Nonnull)number
              displayName:(NSString * _Nonnull)displayName
               forAccount:(VBotAccount * _Nonnull)account completion:(void (^_Nonnull )(VBotCall * _Nullable call, NSError * _Nullable error))completion;
