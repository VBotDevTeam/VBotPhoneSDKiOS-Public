...
#ifndef VBOTPHONEPUBLIC_SWIFT_H
#define VBOTPHONEPUBLIC_SWIFT_H
...
#import <VBotPhonePublic/VBotPhonePublic.h>
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VBotPhonePublic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
enum VBotEndCallReason : NSInteger;
SWIFT_CLASS("_TtC15VBotPhonePublic14VBotCallReport")
...
@property (nonatomic) int64_t ringingTime;
@property (nonatomic) int64_t endTime;
@property (nonatomic) BOOL status;
@property (nonatomic) NSInteger duration;
@property (nonatomic) enum VBotEndCallReason endCallReason;
...
SWIFT_CLASS("_TtC15VBotPhonePublic13VBotOrderInfo")
@interface VBotOrderInfo : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC15VBotPhonePublic9VBotPhone")
...
@class CXCall;
@interface VBotPhone (SWIFT_EXTENSION(VBotPhonePublic))
...
SWIFT_PROTOCOL("_TtP15VBotPhonePublic17VBotPhoneDelegate_")
